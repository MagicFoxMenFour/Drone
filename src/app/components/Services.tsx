      ...
      <div className="max-w-[1440px] mx-auto flex flex-col lg:flex-row">
        <div className="lg:w-1/2 p-8 lg:p-16 lg:border-r border-slate-200">
          ...
          <div className="space-y-20">
            {[
              { t: "Разработка ПО для робототехнических систем", d: "C++, Python, ROS 2, компьютерное зрение, встраиваемые системы и наземные приложения для робототехники и БПЛА." },
              { t: "Монтаж печатных плат", d: "Мелкосерийный SMT и выводной монтаж, контроль профиля пайки, функциональное тестирование каждой платы." },
            ].map((s, i) => (
