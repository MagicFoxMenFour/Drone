...
const faqs = [
  ...
  { q: "Работаете ли вы в горных районах?", a: "Да. Мы выполняем полёты в горах Кавказа — КБР, КЧР, Северная Осетия. Используем специализированные БПЛА для высот до 4 000 м." },
  ...
  { q: "Безопасно ли это?", a: "Все дроны оснащены резервными системами. Каждый полёт застрахован. Пилоты имеют свидетельства ФАВТ РФ." },
  ...
  useEffect(() => {
    ...
    import("leaflet").then((L) => {
      ...
      L.marker([MAP_LAT, MAP_LNG], { icon })
        .addTo(map)
        .bindPopup("<strong>Citrix</strong><br>пр. Кулакова 2, Ставрополь")
        .openPopup();
    });
            ...
            <div>
              <div className="grid sm:grid-cols-2 gap-5 mb-8">
                ...
                <div className="bg-slate-50 border border-slate-200 p-7">
                  ...
                  <a href="tel:+79887635927" className="text-xl font-bold text-slate-950 hover:text-blue-600 transition-colors block">
                    +7 (988) 763-59-27
                  </a>
                  <p className="text-slate-400 text-sm font-medium mt-1">Константин · Пн–Пт 9–18</p>
                </div>
                {/* Email */}
                <div className="bg-slate-50 border border-slate-200 p-7">
                  <div className="text-3xl mb-4">✉️</div>
                  <h3 className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-2">Email</h3>
                  <a href="mailto:p0p0vk@yandex.ru" className="text-lg font-bold text-slate-950 hover:text-blue-600 transition-colors break-all block">
                    p0p0vk@yandex.ru
                  </a>
              ...
              <div className="bg-blue-50 border border-blue-100 p-7">
                <h3 className="text-xs font-bold text-blue-600 uppercase tracking-widest mb-3">Контактное лицо</h3>
                <p className="text-xl font-bold text-slate-950">Попов Константин Андреевич</p>
                <p className="text-slate-500 font-medium mt-1">Главный технический специалист</p>
              </div>
            </div>
                ...
                <form ref={formRef} onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    <select value={form.service}
                      ...
                      <option>Аэрофотосъемка</option>
                      <option>3D-картография</option>
                      <option>Инспекция объектов</option>
                      <option>Агромониторинг</option>
                      <option>Тепловизионная съемка</option>
                      <option>Охрана периметра</option>
                  ...
                  {status === "error" && (
                    <div className="bg-red-50 border border-red-200 px-4 py-3 text-red-700 text-sm font-medium">
                      Ошибка отправки. Напишите нам напрямую: p0p0vk@yandex.ru
                    </div>
                  )}
